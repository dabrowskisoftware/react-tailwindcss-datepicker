...
const RoundedButton = (props) => {
    ...
    const getClassName = require$$0.useCallback(() => {
        ...
        const activeClass = active ? "font-semibold bg-neutral-50 dark:bg-white/5" : "";
        const defaultClass = !roundedFull
            ? `w-full tracking-wide ${darkClass} ${activeClass} transition-all duration-300 px-3 ${padding} uppercase hover:bg-neutral-100 rounded-md focus:ring-1`
            : `${darkClass} ${activeClass} transition-all duration-300 hover:bg-neutral-100 rounded-full p-[0.45rem] focus:ring-1`;
...
const Days = (props) => {
    ...
    const buttonClass = require$$0.useCallback((day, type) => {
        ...
        return classNames(baseClass, isDateDisabled(day) && "line-through", "text-neutral-400");
...
const Week = () => {
    ...
    return (jsxRuntimeExports.jsx("div", { className: "grid grid-cols-7 border-b border-neutral-300 dark:border-neutral-700 py-2", children: DAYS.map(item => (jsxRuntimeExports.jsx("div", { className: "tracking-wide text-neutral-500 text-center", children: ucFirst(shortString(dateFormat(new Date(2022, 10, 6 + item + startDateModifier), "ddd", i18n) || "")) }, item))) }));
};
...
const Calendar = (props) => {
    ...
    return (jsxRuntimeExports.jsxs("div", { className: "w-full md:w-[296px] md:min-w-[296px]", children: [jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-1.5 border border-neutral-300 dark:border-neutral-700 rounded-md px-2 py-1.5", children: [!showMonths && !showYears && (jsxRuntimeExports.jsx("div", { className: "flex-none", children: jsxRuntimeExports.jsx(RoundedButton, { roundedFull: true, onClick: onClickPrevious, children: jsxRuntimeExports.jsx(ChevronLeftIcon, { className: "h-5 w-5" }) }) })), showYears && (jsxRuntimeExports.jsx("div", { className: "flex-none", children: jsxRuntimeExports.jsx(RoundedButton, { roundedFull: true, onClick: () => {
...
const Input = () => {
    ...
    const getToggleClassName = require$$0.useCallback(() => {
        ...
        const defaultToggleClassName = "absolute right-0 h-full px-3 text-neutral-400 focus:outline-none disabled:opacity-40 disabled:cursor-not-allowed";
...
const ItemTemplate = require$$0.memo((props) => {
    ...
    const getClassName = require$$0.useCallback(() => {
        ...
        return `whitespace-nowrap w-1/2 md:w-1/3 lg:w-auto transition-all duration-300 hover:bg-neutral-100 dark:hover:bg-white/10 p-2 rounded cursor-pointer ${textColor} ${textColorHover}`;
    }, [primaryColor]);
...
const Shortcuts = () => {
    ...
    return shortcutOptions?.length ? (jsxRuntimeExports.jsx("div", { className: "md:border-b mb-3 lg:mb-0 lg:border-r lg:border-b-0 border-neutral-300 dark:border-neutral-700 pr-1", children: jsxRuntimeExports.jsx("ul", { className: "w-full tracking-wide flex flex-wrap lg:flex-col pb-1 lg:pb-0", children: shortcutOptions.map(([key, item], index) => Array.isArray(item) ? (item.map((item, index) => (jsxRuntimeExports.jsx(ItemTemplate, { item: item, children: jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: key === "past" &&
                        configs?.shortcuts &&
...
const Datepicker = (props) => {
    ...
    const containerClassNameOverload = require$$0.useMemo(() => {
        const defaultContainerClassName = "relative w-full text-neutral-700";
