    ...
    return (
        <div className="px-4 py-8">
            ...
            <h1 className="text-center font-semibold text-xl">
                <pre className="text-neutral-600 text-lg bg-neutral-200 max-w-max mx-auto px-2 rounded">
                    react-tailwindcss-datepicker
                </pre>
                <span className="text-neutral-700">PlayGround</span>
            </h1>
            ...
            <div className="max-w-md mx-auto my-4">
                <Datepicker
                    ...
                    //     },
                    //     footer: () => {
                    //         return `p-4 border-t border-neutral-600 flex flex-row flex-wrap justify-end`;
                    //     }
                    // }}
                />
            </div>
            <div className="py-4 max-w-3xl mx-auto flex flex-row flex-wrap">
                ...
                <div className="w-full sm:w-1/3 pr-2 flex flex-col">
                    <div className="mb-2">
                        ...
                        <select
                            className="rounded block w-full border-neutral-200 border px-4 py-2"
                            id="primaryColor"
                            value={primaryColor}
                            onChange={e => {
                    ...
                    <div className="mb-2">
                        ...
                        <input
                            className="rounded border px-4 py-2 w-full border-neutral-200"
                            id="placeholder"
                            value={placeholder}
                            onChange={e => {
                ...
                <div className="w-full sm:w-2/3 pr-2 flex flex-col ml-auto">
                    ...
                    <div className="grid grid-cols-2 gap-3 w-full">
                        <div className="mb-2 w-full">
                            ...
                            <input
                                className="rounded border px-4 py-2 border-neutral-200 sm:w-full w-full"
                                id="startDate"
                                type="date"
            ...
            <div className="flex flex-row flex-wrap items-center justify-center w-full">
                <a
                    ...
                    className="block text-neutral-700 hover:text-neutral-600"
                >
                    <svg
